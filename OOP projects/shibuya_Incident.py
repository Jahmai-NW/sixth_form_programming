...
class Sorcerers():
    def __init__(self, theName, theHP, theAttack, theSpecialMove, theRankName, theDomainExpansionName, theDomainValue, theSureHit):
        self.name = theName
        self.hp = theHP
...
YujiItadori = Sorcerers("Yuji Itadori", 3000, 1000, "Black Flash", "Special Grade", "Benevolent Shrine", 200, "gets hit by soul dismantles.")
YutaOkkotsu = Sorcerers("Yuta Okkotsu", 8000, 8000, "Summon Rika", "Special Grade", "Authentic Mutual Love", 400, "is hit by a technique from Yuta's sword.")
SatoruGojo = Sorcerers("Satoru Gojo", 9500, 9500, "200% Hollow Purple", "Special Grade", "Infinite Void", 480, "is forced to bear the weight of boundless information.")
RyomenSukuna = Sorcerers("Ryomen Sukuna", 10000, 10000, "World Cutting Slash", "Special Grade", "Malevolent Shrine", 500, "is hit by endless dismantle and cleave attacks.")
YukiTsukumo = Sorcerers("Yuki Tsukumo", 7000, 7000, "Black Hole", "Special Grade", "Star Rage", 420, "is hit by the effects of infinite mass.")
SuguruGeto = Sorcerers("Suguru Geto", 1500, 1000, "Uzumaki", "Special Grade", "Womb Profusion", 20, "is hit by the onslaught of Cursed Spirits.")
Kenjaku = Sorcerers("Kenjaku", 1500, 6000, "Anti-Gravity", "Special Grade", "Womb Profusion", 490, "is immediately crushed.")
MakiZenin = Sorcerers("Maki Zenin", 2500, 500, "Inhumane Speed", "Heavenly Restricted", None, 0, "invades the domain.")
MegumiFushiguro = Sorcerers("Megumi Fushiguro", 1000, 9000, "Summon Mahoraga", "Grade 2", "Chimera Shadow Garden", 250, "is attacked bu multiple shadows.")
TojiFushiguro = Sorcerers("Toji Fushiguro", 2250, 700, "Sneak Attack", "Heavenly Restricted", None, 0, "invades the domain.")
NaoyaZenin = Sorcerers("Naoya Zenin", 700, 500, "Enforce 24FPS", "Special Grade 1", None, 0, "is safe.")
KinjiHakari = Sorcerers("Kinji Hakari", 6500, 3000, "Instantaneous Regeneration", "Grade 1", "Idle Death Gamble", 390, "is severely injured by Jackpot Hakari.")
HajimeKashimo = Sorcerers("Hajime Kashimo", 7800, 7800, "Mythical Beast Amber", "Special Grade", None, 0, "is safe.")


Mahito = CursedSpirit("Mahito", 6000, 4000, "Embodiment of Perfection", "Special Grade", "Self-Embodiment Of Perfection", 450, "is forcefully morphed, as a result of Idle Transfiguration.")
Jogo = CursedSpirit("Jogo", 1500, 3000, "Maximum Meteor", "Special Grade", "Coffin of the Iron Mountain", 425, "is severely burned.")
Dagon = CursedSpirit("Dagon", 1000, 1500, "Awakening Form", "Special Grade", "Horizon of the Captivating Skandha", 400, "is attacked by sea creatures.")
Choso = CursedSpirit("Choso", 2000, 2000, "Supernova", "Grade 1", None, 0, "is safe.")
Naoya = CursedSpirit("Cursed Spirit Naoya", 4000, 4000, "Apply 24FPS on Air", "Special Grade", "Time Cell Moon Palace", 470, "fails to abide by Naoya's 24FPS rule. Their cells are shredded and torn apart.")
...
while True:
    print('''
        1. Sorcerer vs Sorcerer
        2. Cursed Spirit vs Cursed Spirit
        3. Sorcerer vs Cursed Spirit
        4. Domain Clash between Sorcerers and Cursed Spirits
    ''')
